...
> **This is a fork** — [darcwader/pi](https://github.com/darcwader/pi)

This fork differs from upstream in how project context files (`CLAUDE.md`, `AGENTS.md`) and skills are loaded:
